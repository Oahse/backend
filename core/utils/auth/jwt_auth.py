...
class JWTManager:
    def __init__(self, secret_key: str, algorithm: str = "HS256"):
        ...
        self.ACCESS_TOKEN_EXPIRE_TIME = timedelta(hours=1)  # Access token expires in 1 hour
        self.REFRESH_TOKEN_EXPIRE_TIME = timedelta(days=7)  # Refresh token expires in 7 days
